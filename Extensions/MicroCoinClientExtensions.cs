...
namespace MicroCoin {
	public static class MicroCoinClientExtensions {

		#region Lock scopes

		public static IDisposable EnterUnlockWalletScope(this IMicroCoinClient client, string pwd) {
		...
		public static async Task<IDisposable> EnterUnlockScopeAsync(this IMicroCoinClient client, string pwd) {
		...
		public static Task<PublicKeyDTO[]> GetWalletPubKeysAsync(this IMicroCoinClient client, int? start = null, int? max = null) {
		...
		/// <returns>Returns a MCC value with maximum 4 decimals</returns>
		public static Task<decimal> GetWalletCoinsAsync(this IMicroCoinClient client, string enc_pubkey = null, string b58_pubkey = null) {
		...
		public static Task<BlockDTO> GetBlockAsync(this IMicroCoinClient client, uint block) {
		...
		/// <returns></returns>
		public static Task<BlockDTO[]> GetBlocksAsync(this IMicroCoinClient client, uint? last = null, int? start = null, int? end = null) {
		...
		public static Task<uint> GetBlockCountAsync(this IMicroCoinClient client) {
		...
		public static Task<OperationDTO> GetBlockOperationAsync(this IMicroCoinClient client, uint block, uint opblock) {
		...
		public static Task<OperationDTO[]> GetBlockOperationsAsync(this IMicroCoinClient client, uint block, int? start = null, int? max = null) {
		...
		public static Task<OperationDTO[]> GetAccountOperationsAsync(this IMicroCoinClient client, uint account, int? depth = null, int? start = null, int? max = null) {
		...
		public static Task<OperationDTO[]> GetPendingsAsync(this IMicroCoinClient client) {
		...
		public static Task<OperationDTO> FindOperationAsync(this IMicroCoinClient client, string ophash) {
		...
		public static Task<OperationDTO> ChangeAccountInfoAsync(this IMicroCoinClient client, uint account_target, uint account_signer, string new_enc_pubkey, string new_b58_pubkey, string new_name, ushort? new_type, decimal fee, byte[] payload = null, PayloadEncryptionMethod? payloadMethod = null, string pwd = null) {
		...
		/// </summary>
		/// <returns></returns>
		public static Task<bool> StopNodeAsync(this IMicroCoinClient client) {
